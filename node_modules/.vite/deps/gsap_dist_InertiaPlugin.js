...
var require_InertiaPlugin = __commonJS({
  "node_modules/gsap/dist/InertiaPlugin.js"(exports, module) {
    (function(global, factory) {
      ...
      "use strict";
      var gsap, _coreInitted, _toArray, _getUnit, _first, _ticker, _time1, _time2, _getCache, _getGSAP = function _getGSAP2() {
        return gsap || typeof window !== "undefined" && (gsap = window.gsap);
      }, _lookup = {}, _round = function _round2(value) {
      ...
      var VelocityTracker = (function() {
        ...
        VelocityTracker2.register = function register(core) {
          gsap = core;
          _initCore();
        };
      ...
      var gsap$1, _coreInitted$1, _parseEase, _toArray$1, _power3, _config, _getUnit$1, PropTween, _getCache$1, _checkPointRatio, _clamp, _processingVars, _getStyleSaver, _reverting, _getTracker = VelocityTracker.getByTarget, _getGSAP$1 = function _getGSAP2() {
        ...
        return p;
      }, _bigNum = 1e10, _tinyNum = 1 / _bigNum, _checkPoint = 0.05, _round$1 = function _round2(value) {
        return Math.round(value * 1e4) / 1e4;
        ...
        var duration = 0, clippedDuration = _bigNum, inertiaVars = vars.inertia || vars, getVal = _getCache$1(target).get, resistance = _getNumOrDefault(inertiaVars, "resistance", _config.resistance), p, curProp, curDuration, curVelocity, curVal, end, curClippedDuration, tracker, unitFactor, linkedProps;
      ...
      exports2.InertiaPlugin = InertiaPlugin;
      exports2.VelocityTracker = VelocityTracker;
      exports2.default = InertiaPlugin;
      Object.defineProperty(exports2, "__esModule", { value: true });
    }));
  }
});
export default require_InertiaPlugin();
//# sourceMappingURL=gsap_dist_InertiaPlugin.js.map
